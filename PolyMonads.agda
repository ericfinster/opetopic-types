...
module PolyMonads where
  ...
  postulate
    ...
    ∂ : {I : Type₀} (M : Mnd I) (i : I) (c : γ M i) (X : I → Type₀) → Type₀
    ev : {I : Type₀} (M : Mnd I) (i : I) (c : γ M i) (X : I → Type₀)
      → (d : ∂ M i c X)
      → (p : ρ M i c) → X (τ M i c p)

    -- ∂-in : {I : Type₀} (M : Mnd I) (i : I) (c : γ M i) (X : I → Type₀)
    --   → Π I X → ∂ M i c X

    η : {I : Type₀} (M : Mnd I) (i : I) → γ M i

    η-dec-r : {I : Type₀} (M : Mnd I) (i : I) (c : γ M i)
      → ∂ M i c (γ M)
  
    η-dec-l : {I : Type₀} (M : Mnd I) (i : I) (X : I → Type₀)
      → X i → ∂ M i (η M i) X

    μ : {I : Type₀} (M : Mnd I) (i : I) (c : γ M i) (δ : ∂ M i c (γ M)) → γ M i
  ...
  --     {-# REWRITE μρ-η #-}
      ...
      unit-r : (i : I) (c : γ M i) 
        → μ M i c (η-dec-r M i c) ↦ c

  --     {-# REWRITE unit-l #-}

      unit-l : (i : I) (c : γ M i)
        → μ M i (η M i) (η-dec-l M i (γ M) c) ↦ c
